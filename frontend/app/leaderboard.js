  ...
  return (
    <>
        <SafeAreaView className="h-[2000px] flex flex-col pb-28 bg-[#202020] -mt-16">
          <View>
            <Text className="mt-3 text-white text-[63px] tracking-[10px] text-center font-[Koulen] ml-2">Leaderboard</Text>
          ...
          <View className="flex-col justify-center -mt-8">
            <View className="flex-row gap-x-4 items-center justify-center">
              ...
              <Text className="text-6xl font-[Koulen] text-white leading-[150px]">TEMU</Text>
              <Text className="text-md font-semibold text-green-500 font-[Koulen]">224 points</Text>
            </View>
            <View className="ml-8 mr-8 -mt-8">
              {[
                ...
                <View key={index} className="flex-row items-center justify-between px-4 my-2">
                  ...
                  <Text className="flex-1 text-2xl font-bold uppercase text-white text-center font-[Koulen]">{item.name}</Text>
